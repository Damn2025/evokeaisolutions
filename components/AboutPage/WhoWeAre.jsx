...
const WhoWeAre = () => {
  ...
  return (
    <section className="ap-who-we-are-section" id="company" ref={sectionRef}>
      <div className={`ap-who-we-are-container ${isVisible ? 'ap-animate-in' : ''}`}>
        <div className="ap-who-we-are-box">
          <div className="ap-who-we-are-content-side">
            <div className="ap-feature-group">
              <h4>CORE SERVICES</h4>
              <ul>
            ...
            <div className="ap-feature-group">
              ...
              <p className="ap-feature-intro">EVOKE AI is powered by specialized tools designed for different business needs:</p>
              <ul>
          ...
          <div className="ap-who-we-are-image-side">
            <img
              src="/about_assets/evoke1.webp"

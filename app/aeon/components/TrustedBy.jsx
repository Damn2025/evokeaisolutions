...
const AstroremedisLogo = '/aeon/Astroremedis.png';
const EduonixLogo = '/aeon/eduonix.png';
const SipconLogo = '/aeon/Sipcon.jpg';
const damnartLogo = '/aeon/Damnart.png';
const eurocertLogo = '/aeon/eurocert.webp';
const itcLogo = '/aeon/itc.png';
const sustainableLogo = '/aeon/Sustainable.jpg';
const grnataLogo = '/aeon/Grnata.png';

...
const SectorCard: React.FC<{ sector: typeof SECTORS[0], index: number }> = ({ sector, index }) => {
  ...
  return (
    <div
      ...
      className={`
        relative flex-shrink-0 w-80 min-w-[320px] h-[400px] md:w-[360px] md:min-w-[360px] md:h-[440px]
    ...
    >
      ...
      {/* Content */}
      <div className="p-5 md:p-6 flex flex-col h-[55%] relative z-30">
        <div className={`
          w-12 h-12 rounded-lg bg-slate-50 flex items-center justify-center mb-3 shadow-sm
...
export default function Sectors() {
  ...
  return (
    <section id="industries" className="min-h-[auto] md:min-h-screen flex flex-col justify-start md:justify-center py-24 md:py-12 scroll-mt-24 relative overflow-hidden bg-transparent">
      ...
      <div className="max-w-8xl mx-auto px-4 relative z-10 w-full overflow-hidden md:overflow-visible">
        {/* Header Section */}
        ...
        <div className="flex flex-nowrap lg:justify-center gap-5 overflow-x-auto overflow-y-hidden pb-10 px-2 -mx-2 w-full scroll-smooth">
      ...
      <style dangerouslySetInnerHTML={{
        __html: `
        /* Optional custom scrollbar styling can go here */
      `}} />
    </section>
  );
}
